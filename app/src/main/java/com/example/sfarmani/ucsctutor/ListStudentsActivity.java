...
public class ListStudentsActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_list_students);
        showSpinner();
        ...
        Intent serviceIntent = new Intent(ListStudentsActivity.this, SinchService.class);
        startService(serviceIntent);

        // Locate Button in content_list_students.xmlents.xml
